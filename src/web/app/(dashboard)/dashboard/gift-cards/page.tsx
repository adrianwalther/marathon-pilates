    ...
    <div style={{ padding: '3rem 2.5rem', maxWidth: '620px' }}>
      ...
      <div style={{ display: 'flex', gap: '0', marginBottom: '2.5rem', border: '1px solid #e0e0e0', borderRadius: '2px', overflow: 'hidden', width: 'fit-content' }}>
        {(['buy', 'redeem'] as Mode[]).map(m => (
          <button key={m} onClick={() => setMode(m)} style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: '0.65rem', letterSpacing: '0.12em', textTransform: 'uppercase', padding: '0.6rem 1.5rem', border: 'none', background: mode === m ? '#1a1a1a' : 'white', color: mode === m ? 'white' : 'var(--color-text-muted)', cursor: 'pointer' }}>
