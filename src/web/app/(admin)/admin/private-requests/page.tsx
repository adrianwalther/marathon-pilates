    ...
    <div style={{ padding: '3rem 2.5rem', maxWidth: '1000px' }}>
      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          {requests.map(req => {
            const statusStyle = STATUS_COLORS[req.status] ?? { bg: '#f0f0f0', color: 'var(--color-text-muted)' }
            const client = req.profiles
            return (
              <div key={req.id} style={{ background: 'white', border: activeId === req.id ? '1px solid var(--color-cta)' : '1px solid #eee', borderRadius: '2px', padding: '1.25rem 1.5rem' }}>
                  ...
                  {(req.status === 'pending' || req.status === 'proposed') && (
                    <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
                      <button
                        ...
                        style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: '0.62rem', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '0.5rem 1rem', border: 'none', borderRadius: '2px', background: 'var(--color-cta)', color: 'white', cursor: 'pointer' }}
                      >
                      ...
                      <button
                        ...
                        style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: '0.62rem', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '0.5rem 1rem', border: '1px solid #e0e0e0', borderRadius: '2px', background: 'white', color: 'var(--color-text-muted)', cursor: 'pointer' }}
                      >
                        Decline
                      </button>
                    </div>
                ...
                {activeId === req.id && activeReq && (
                  <div style={{ marginTop: '1.25rem', paddingTop: '1.25rem', borderTop: '1px solid #f0f0f0' }}>
                    ...
                    <button
                      ...
                      style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: '0.68rem', letterSpacing: '0.12em', textTransform: 'uppercase', padding: '0.65rem 1.5rem', border: 'none', borderRadius: '2px', background: saving || !proposedTime ? 'var(--color-cta-disabled)' : 'var(--color-cta)', color: 'white', cursor: saving || !proposedTime ? 'not-allowed' : 'pointer' }}
                    >
