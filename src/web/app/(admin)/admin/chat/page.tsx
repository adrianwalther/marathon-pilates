    ...
    <div style={{ display: 'flex', height: 'calc(100vh - 4rem)', fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div style={{ width: 300, borderRight: '1px solid #f0f0f0', display: 'flex', flexDirection: 'column', background: '#fff', flexShrink: 0 }}>
        <div style={{ padding: '1rem', borderBottom: '1px solid #f0f0f0' }}>
          ...
          <input
            ...
            style={{ width: '100%', background: 'var(--color-bg)', border: 'none', borderRadius: 4, padding: '0.4rem 0.75rem', fontSize: '0.8rem', color: '#4b5563', outline: 'none', boxSizing: 'border-box' }}
          />
        </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          {loading ? (
            ...
            <>
              {open.map(convo => (
                <div
                  ...
                  style={{
                    ...
                    background: selectedId === convo.id ? 'var(--color-bg)' : '#fff',
              ...
              {closed.length > 0 && (
                <>
                  <div style={{ padding: '0.5rem 1rem', background: 'var(--color-bg)', borderBottom: '1px solid #f0f0f0' }}>
                  ...
                  {closed.map(convo => (
                    <div
                      key={convo.id}
                      onClick={() => setSelectedId(convo.id)}
                      style={{ padding: '0.875rem 1rem', cursor: 'pointer', borderBottom: '1px solid var(--color-bg)', background: selectedId === convo.id ? 'var(--color-bg)' : '#fff', opacity: 0.6 }}
                    >
      ...
      {selected ? (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          {/* Messages */}
          <div style={{ flex: 1, overflowY: 'auto', padding: '1.5rem', background: 'var(--color-bg)', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {messages.length === 0 ? (
