...
export default function AdminOverviewPage() {
  ...
  const sectionLabel = { fontFamily: "'Raleway', sans-serif", fontWeight: 700 as const, fontSize: '0.65rem', letterSpacing: '0.18em', textTransform: 'uppercase' as const, color: 'var(--color-text-muted)', marginBottom: '1rem' }
    ...
    <div style={{ padding: '3rem 2.5rem', maxWidth: '1000px' }}>
      ...
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          ...
          <Link href="/admin/schedule" style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 600, fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--color-cta)', textDecoration: 'none' }}>View all</Link>
        </div>
        ...
        {loading ? (
          ...
          <div style={{ background: 'white', border: '1px solid #eee', borderRadius: '2px', padding: '2rem', textAlign: 'center' }}>
            ...
            <Link href="/admin/schedule" style={{ display: 'inline-block', marginTop: '1rem', fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: '0.7rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--color-cta)', textDecoration: 'none' }}>Add a class →</Link>
          </div>
        ) : (
...
function ActionBtn({ href, label, primary }: { href: string; label: string; primary?: boolean }) {
  return (
    <Link href={href} style={{ fontFamily: "'Raleway', sans-serif", fontWeight: 700, fontSize: '0.7rem', letterSpacing: '0.12em', textTransform: 'uppercase', padding: '0.65rem 1.25rem', borderRadius: '2px', border: primary ? 'none' : '1px solid var(--color-cta)', background: primary ? 'var(--color-cta)' : 'transparent', color: primary ? 'white' : 'var(--color-cta)', textDecoration: 'none' }}>
      {label}
    </Link>
  )
}
